...
public class LobPong extends JPanel implements ActionListener, KeyListener, LineListener, MouseListener {
	...
	protected Clip clip;
	protected String [] tracksArray = {"Circuit Breakin'.wav", "Life Force.wav", "Time Trial.wav", "White Specks in a Black Cloud.wav", "1 for Wily.wav", "Progstep.wav", "1 For Kutmah.wav", "Dat Ass.wav", "Big Like Curby.wav"};
